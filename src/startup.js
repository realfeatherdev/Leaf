...
system.beforeEvents.startup.subscribe(async (init) => {
    ...
    system.runTimeout(async () => {
        config = await import("./api/config/configAPI.js");
        worldTags = await import("./worldTags.js");
        normalForm = await import("./api/openers/normalForm.js");
        itemdb = await import("./api/itemdb.js");
        libPDB = await import("./lib/prismarinedb.js");
        uiBuilder = await import("./api/uiBuilder.js");

        // You can now use these modules safely for non-critical logic
    }, 0); // 0 ticks delay ensures registration runs first
