...
import './features/endDisabler.js'
...
import "./uis/uiBuilder/add.js";
import "./uis/uiBuilder/edit.js";
import "./uis/uiBuilder/editButtons.js";
...
import "./uis/lock/lock.js";
import "./uis/uiBuilder/tabbed/edit_tabs.js";
import "./uis/uiBuilder/tabbed/root.js";
import "./uis/uiBuilder/info.js";
import "./uis/uiBuilder/addButton.js";
import "./uis/uiBuilder/editButton.js";
import "./uis/config/root.js";
import "./uis/config/main.js";
import "./uis/config/misc.js";
...
import "./commands/uisList.js";
import "./commands/warp.js";
import "./commands/speakas.js";
import './commands/lore.js'
import "./uis/chests/add.js";
import "./uis/chests/edit.js";
import "./uis/chests/editItems.js";
import './features/hivekb.js'
import './features/item_nametag.js'
import './features/delag.js'
import './features/quests.js'
import './features/mobStacking.js'
import './features/skills.js'
import './features/loggerAPI.js'
import './features/xrayDetection.js'
import "./uis/chests/addItem.js";
import "./uis/chests/editItem.js";
import "./uis/sidebar/root.js";
import "./uis/sidebar/add.js";
import "./uis/sidebar/settings.js";
import "./leaficon.js";
import "./uis/sidebar/edit.js";
import "./uis/sidebar/addLine.js";
import "./uis/sidebar/editLine.js";
import "./uis/uiBuilder/onlineGuis.js";
import "./uis/sidebar/trash.js";
import "./uis/pay.js";
import "./uis/sidebar/trashEdit.js";
import "./uis/currencyEditor/root.js";
import "./uis/currencyEditor/add.js";
import "./uis/uiBuilder/editActions.js";
// import './crates/main';
import "./uis/basic/basicConfirmation.js";
import "./features/chestLocking.js";
...
import { entitySel } from './lib/MCSelectorLib.js';
try {
    entitySel()
} catch {}
...
let e = world.getDynamicProperty("AOP_11x");
if (!a) {
...
if(!e) {
    uiBuilder.db.waitLoad().then(()=>{
        let ui = uiBuilder.db.findFirst({scriptevent: "leaf/tpr"});
        ui.data.theme = 68;
        uiBuilder.db.overwriteDataByID(ui.id, ui.data)

    })
    world.setDynamicProperty("AOP_11x", true)
}
if(!c) {
    uiBuilder.db.waitLoad().then(()=>{
        let folderID = uiBuilder.createFolder("Leaf")
  ...
  "buttons": [
    ...
    },
    {
      ...
      "nutUIHeaderButton": false
        ...
        {
      "text": "§dWorldborder",
      "subtext": "Configure the worldborder",
      "action": "/scriptevent leafgui:worldborder",
      "actions": [
        "/scriptevent leafgui:worldborder"
      ],
      "iconID": "rpgiab/grid",
      "iconOverrides": [],
      "requiredTag": "",
    ...
    {
      "text": "§aAFK System",
      "subtext": "Configure AFK system",
      "action": "/scriptevent leafgui:afk",
      "actions": [
        "/scriptevent leafgui:afk"
      ],
...
try {
    configAPI.registerProperty("LastLeafVer", configAPI.Types.Number, versionData.versionInfo.versionInternalID);
    configAPI.db.waitLoad().then(()=>{
        if(versionData.versionInfo.versionInternalID > configAPI.getProperty("LastLeafVer")) {
            configAPI.setProperty("LastLeafVer", versionData.versionInfo.versionInternalID)
        }
    })
