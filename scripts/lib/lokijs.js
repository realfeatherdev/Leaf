...
let window = {
    localStorage: new SimulatedLocalStorage(),
};
    ...
    return (function () {
        ...
        function dotSubScan(root, paths, fun, value, extra, poffset) {
            ...
            if (pathOffset + 1 >= paths.length) {
                ...
                for (
                    var index = 0, len = element.length;
                    index < len;
                    index += 1
                ) {
        ...
        var LokiOps = {
            ...
            $between: function (a, vals) {
                ...
                return (
                    Comparators.gt(a, vals[0], true) &&
                    Comparators.lt(a, vals[1], true)
                );
            },
         ...
         * @memberof LokiEventEmitter
         */
        LokiEventEmitter.prototype.removeListener = function (
            eventName,
            listener
        ) {
            var self = this;
       ...
       */
        function Loki(filename, options) {
            ...
            this.verbose =
                options && options.hasOwnProperty("verbose")
                    ? options.verbose
                    : false;
        ...
        Loki.prototype.configureOptions = function (options, initialConfig) {
            ...
            if (typeof options !== "undefined") {
                ...
                if (this.options.hasOwnProperty("persistenceMethod")) {
                    ...
                    if (
                        typeof persistenceMethods[options.persistenceMethod] ==
                        "function"
                    ) {
                ...
                if (this.options.hasOwnProperty("adapter")) {
                    ...
                    this.isIncremental =
                        this.persistenceAdapter.mode === "incremental";
                }
                ...
                if (
                    this.options.hasOwnProperty("autosave") &&
            ...
            for (i = 0; i < len; i += 1) {
                if (this.collections[i].name === collectionName) {
                    ...
                    for (var prop in curcol) {
                        if (
                            curcol.hasOwnProperty(prop) &&
                            tmpcol.hasOwnProperty(prop)
                        ) {
        ...
        Loki.prototype.serializeCollection = function (options) {
            ...
            for (docidx = 0; docidx < doccount; docidx++) {
                resultlines.push(
                    JSON.stringify(
                        this.collections[options.collectionIndex].data[docidx]
                    )
                );
            }
        ...
        Loki.prototype.deserializeDestructured = function (
            ...
            if (options.partitioned) {
                ...
                for (collIndex = 0; collIndex < collCount; collIndex++) {
                    ...
                    cdb.collections[collIndex].data =
            ...
            for (i; i < len; i += 1) {
                ...
                if (coll.getData) {
                    if (
                        ...
                        throw new Error(
                            "this collection cannot be loaded lazily: " +
                                coll.name
                        );
                    }
                ...
                copyColl.maxId =
                    typeof coll.maxId === "undefined" ? 0 : coll.maxId;
                ...
                for (var idx = 0; idx < coll.DynamicViews.length; idx++) {
                    ...
                    var dv = copyColl.addDynamicView(
                        colldv.name,
                        colldv.options
                    );
                    ...
                    dv.resultset.filterInitialized =
                        colldv.resultset.filterInitialized;
      ...
      -------------------*/
         ...
         * @memberof LokiMemoryAdapter
         */
        LokiMemoryAdapter.prototype.deleteDatabase = function (
            dbname,
            callback
        ) {
            if (this.hashStore.hasOwnProperty(dbname)) {
        ...
        LokiPartitioningAdapter.prototype.loadNextPage = function (callback) {
            ...
            this.adapter.loadDatabase(keyname, function (result) {
                ...
                for (idx = 0; idx < dlen; idx++) {
                    self.dbref.collections[
                        self.pageIterator.collection
                    ].data.push(JSON.parse(data[idx]));
                    data[idx] = null;
                }
                data = [];
        ...
        LokiPartitioningAdapter.prototype.saveNextPartition = function (
            ...
            var keyname =
                this.dbname + (partition === -1 ? "" : "." + partition);
         ...
         * @memberof LokiLocalStorageAdapter
         */
        LokiLocalStorageAdapter.prototype.deleteDatabase =
                    ...
                    this.throttledCallbacks.push(function () {
                        ...
                        if (self.throttledSavePending) {
                            ...
                            if (
                                ...
                                now - options.started >
                                    options.recursiveWaitLimitDuration
                            ) {
                                callback(false);
                                return;
                            }
                ...
                this.persistenceAdapter.saveDatabase(
                    ...
                    function getLokiCopy() {
                        ...
                        if (cachedDirty) {
                            cFun(
                                new Error(
                                    "adapter error - getLokiCopy called more than once"
                                )
                            );
                            return;
                        }
                        ...
                        cachedDirty = self.collections.map(function (
                            collection
                        ) {
        ...
        Loki.prototype.autosaveEnable = function (options, callback) {
            ...
            // this.autosaveHandle = system.runInterval(
            //     function autosaveHandleInterval() {
        ...
        Loki.prototype.autosaveDisable = function () {
            if (
                ...
                system.clearRun(this.autosaveHandle);
                this.autosaveHandle = null;
            }
        };
        ...
        Resultset.prototype.simplesort = function (propname, options) {
            var eff,
                ...
                hasBinaryIndex =
                    this.collection.binaryIndices.hasOwnProperty(propname);
            ...
            if (!property || queryObject === "getAll") {
                if (firstOnly) {
                    if (this.filterInitialized) {
                        ...
                        this.filteredrows =
                            this.collection.data.length > 0 ? [0] : [];
                        this.filterInitialized = true;
                    }
                }
                ...
                if (!searchByIndex) {
                    ...
                    if (usingDotNotation) {
                        ...
                        for (i = 0; i < len; i++) {
                            record = t[i];
                            if (
                                dotSubScan(record, property, fun, value, record)
                            ) {
                                result.push(i);
                                if (firstOnly) {
                                    this.filteredrows = result;
                    ...
                    // search by index
                    var segm = this.collection.calculateRange(
                        operator,
                        property,
                        value
                    );
            ...
            try {
                ...
                if (this.filterInitialized) {
                    ...
                    while (j--) {
                        if (
                            viewFunction(
                                this.collection.data[this.filteredrows[j]]
                            ) === true
                        ) {
        ...
        Resultset.prototype.data = function (options) {
            ...
            if (options.removeMeta && !options.forceClones) {
                ...
                options.forceCloneMethod =
                    options.forceCloneMethod || "shallow";
            }
            ...
            if (this.collection.cloneObjects || options.forceClones) {
                method =
                    options.forceCloneMethod || this.collection.cloneMethod;
                for (i = 0; i < len; i++) {
        ...
        DynamicView.prototype.removeDocument = function (objIndex) {
            ...
            if (Object.keys(fxo).length > 0) {
                ...
                this.resultset.filteredrows =
                    this.resultset.filteredrows.filter(function (di, idx) {
                        return !fxo[idx];
                    });
                // if persistent...
                if (this.options.persistent) {
                    // remove from resultdata
                    this.resultdata = this.resultdata.filter(function (
                        obj,
                        idx
                    ) {
                        return !fxo[idx];
         ...
         * @memberof DynamicView
         */
        DynamicView.prototype.mapReduce = function (
            mapFunction,
            reduceFunction
        ) {
            try {
        ...
        function Collection(name, options) {
            ...
            this.serializableIndices = options.hasOwnProperty(
                "serializableIndices"
            )
            ...
            if (options && options.indices) {
                if (
                    Object.prototype.toString.call(options.indices) ===
                    "[object Array]"
                ) {
            ...
            function getObjectDelta(oldObject, newObject) {
                ...
                if (
                    ...
                    ["string", "boolean", "number"].indexOf(typeof newObject) <
                        0
                ) {
                    var delta = {};
        ...
        Collection.prototype.updateMetaWithChange = function (
            obj,
            old,
            objFrozen
        ) {
      ...
      +----------------------------*/
        Collection.prototype.ttlDaemonFuncGen = function () {
            ...
            return function ttlDaemon() {
                ...
                var toRemove = collection
                    .chain()
                    .where(function daemonFilter(member) {
                        var timestamp =
                            member.meta.updated || member.meta.created;
        ...
        Collection.prototype.setTTL = function (age, interval) {
            if (age < 0) {
                try {
                    system.clearRun(this.ttl.daemon);
                } catch {}
            } else {
                this.ttl.age = age;
                this.ttl.ttlInterval = interval;
                // this.ttl.daemon = system.runInterval(
                //     this.ttlDaemonFuncGen(),
                //     Math.floor(interval / 1000) * 20
                // );
            }
        };
      ...
      +----------------------------*/
        ...
        Collection.prototype.checkIndex = function (property, options) {
            ...
            if (
                options.randomSamplingFactor &&
                options.randomSampling !== false
            ) {
            ...
            if (!this.binaryIndices.hasOwnProperty(property)) {
                throw new Error(
                    "called checkIndex on property without an index: " +
                        property
                );
            }
            ...
            if (len === 1) {
                ...
                if (options.randomSampling) {
                    ...
                    if (valid) {
                        ...
                        iter = Math.floor(
                            (len - 1) * options.randomSamplingFactor
                        );
        ...
        Collection.prototype.getBinaryIndexValues = function (property) {
            ...
            for (idx = 0; idx < idxvals.length; idx++) {
                result.push(
                    Utils.getIn(this.data[idxvals[idx]], property, true)
                );
            }
        ...
        Collection.prototype.insert = function (doc, overrideAdaptiveIndices) {
            ...
            results = this.cloneObjects
                ? clone(results, this.cloneMethod)
                : results;
        ...
        Collection.prototype.update = function (doc) {
            ...
            try {
                ...
                this.uniqueNames.forEach(function (key) {
                    self.getUniqueIndex(key, true).update(
                        oldInternal,
                        newInternal
                    );
                });
                ...
                if (this.disableChangesApi) {
                    ...
                    newInternal = this.updateMetaWithChange(
                        newInternal,
                        oldInternal
                    );
                }
      ...
      +----------------------*/
        ...
        KeyValueStore.prototype = {
            ...
            get: function (key) {
                return this.values[
                    binarySearch(this.keys, key, this.sort).index
                ];
            },
        };
